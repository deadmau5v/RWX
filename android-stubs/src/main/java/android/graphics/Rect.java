...
public final class Rect {
    ...
    public int c;
    public int d;
    // Deobfuscated field aliases (for compilation compatibility)
    public int left;
    public int top;
    public int right;
    public int bottom;
    ...
    public void set(int i, int i2, int i3, int i4) { a(i, i2, i3, i4); }
    ...
    public void set(Rect rect) { a(rect); }
    ...
    public void offset(int i, int i2) { a(i, i2); }
