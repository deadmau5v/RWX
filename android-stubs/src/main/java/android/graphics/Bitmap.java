...
public final class Bitmap implements Parcelable {
    ...
    public Bitmap copy(Config config, boolean z) { return a(config, z); }
    ...
    public static Bitmap createBitmap(int i2, int i3, Config config) { return a(i2, i3, config); }
    ...
    public final int getWidth() { return b(); }
    public final int b() {
        return this.f;
    }

    public final int getHeight() { return c(); }
    public final int c() {
        return this.g;
    }

    public final Config getConfig() { return d(); }
    ...
    public int getPixel(int i2, int i3) { return a(i2, i3); }
    ...
    public void getPixels(int[] iArr, int i2, int i3, int i4, int i5, int i6, int i7) { a(iArr, i2, i3, i4, i5, i6, i7); }
    ...
    public void setPixel(int i2, int i3, int i4) { a(i2, i3, i4); }
    ...
    public void setPixels(int[] iArr, int i2, int i3, int i4, int i5, int i6, int i7) { b(iArr, i2, i3, i4, i5, i6, i7); }
