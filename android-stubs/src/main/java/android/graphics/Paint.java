...
public class Paint {
    ...
    public void set(Paint paint) { a(paint); }
    ...
    public void setAntiAlias(boolean z) { a(z); }
    ...
    public void setDither(boolean z) { b(z); }
    public void b(boolean z) {
    }

    public void setFilterBitmap(boolean z) { c(z); }
    public void c(boolean z) {
    }

    public void setSubpixelText(boolean z) { d(z); }
    ...
    public void setStyle(Style style) { a(style); }
    ...
    public void setColor(int i2) { b(i2); }
    ...
    public void setAlpha(int i2) { c(i2); }
    public void c(int i2) {
        this.n = Color.a(i2, Color.b(this.n), Color.c(this.n), Color.d(this.n));
    }

    public void setARGB(int i2, int i3, int i4, int i5) { a(i2, i3, i4, i5); }
    ...
    public void setStrokeWidth(float f) { a(f); }
    public void a(float f) {
        this.o = f;
    }

    public void setStrokeCap(Cap cap) { a(cap); }
    ...
    public ColorFilter setColorFilter(ColorFilter colorFilter) { return a(colorFilter); }
    ...
    public Xfermode setXfermode(PorterDuffXfermode xfermode) { return a((Xfermode) xfermode); }
    ...
    public Typeface setTypeface(Typeface typeface) { return a(typeface); }
    ...
    public void setTextAlign(Align align) { a(align); }
    ...
    public void setTextSize(float f) { b(f); }
    public void b(float f) {
        this.q = f;
    }

    public float ascent() { return l(); }
    public float l() {
        return -this.q;
    }

    public float descent() { return m(); }
    public float m() {
        return 0.0f;
    }
