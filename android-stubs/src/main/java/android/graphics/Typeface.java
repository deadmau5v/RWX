...
public class Typeface {
    ...
    public static final Typeface DEFAULT = a;
    public static final Typeface b = a((String) null, 1);
    public static final Typeface DEFAULT_BOLD = b;
    public static final Typeface c = a("sans-serif", 0);
    public static final Typeface SANS_SERIF = c;
    ...
    public static Typeface create(Typeface typeface, int i2) { return a(typeface, i2); }
