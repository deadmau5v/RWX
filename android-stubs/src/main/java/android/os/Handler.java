...
public class Handler {
    ...
    public final Message obtainMessage() { return a(); }
    public final Message a() {
        return Message.a(this);
    }

    public final boolean post(Runnable runnable) { return a(runnable); }
    public final boolean a(Runnable runnable) {
        return a(b(runnable), 0L);
    }

    public final boolean sendMessage(Message message) { return c(message); }
