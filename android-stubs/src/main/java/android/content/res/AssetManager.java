...
public final class AssetManager {
    ...
    public final AssetFileDescriptor openFd(String str) throws FileNotFoundException { return b(str); }
    ...
    public final String[] list(String str) throws java.io.IOException { return c(str); }
