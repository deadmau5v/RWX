...
public class MapLayer {
    ...
    static {
        ...
        paintFillBlack.setColor(-16777216);
        paintFillBlack.setStyle(Paint.Style.FILL);
        alphaFillPaints = new GamePaint[11];
        for (int i5 = 0; i5 <= 10; i5++) {
            alphaFillPaints[i5] = new GamePaint();
            alphaFillPaints[i5].setColor(-16777216);
            alphaFillPaints[i5].setStyle(Paint.Style.FILL);
            alphaFillPaints[i5].c(i5 * 25);
        }
        dynamicAlphaFillPaint = new GamePaint();
        dynamicAlphaFillPaint.setColor(-16777216);
        dynamicAlphaFillPaint.setStyle(Paint.Style.FILL);
        groundTexturePaint = new GamePaint();
        groundTexturePaint.setAntiAlias(false);
        groundTexturePaint.setAntiAlias(false);
        groundTexturePaint.setFilterBitmap(false);
        groundScaledTexturePaint = new GamePaint();
        groundScaledTexturePaint.setAntiAlias(true);
        objectsTexturePaint = new GamePaint();
        objectsTexturePaint.setAntiAlias(false);
        objectsTexturePaint.setAntiAlias(false);
        objectsTexturePaint.setFilterBitmap(false);
        objectsScaledTexturePaint = new GamePaint();
        objectsScaledTexturePaint.setAntiAlias(true);
        lightingPaints = new GamePaint[11];
        for (int i6 = 0; i6 <= 10; i6++) {
            GamePaint gamePaint = new GamePaint();
            gamePaint.setColorFilter(new LightingColorFilter(Color.rgb(255 - (i6 * 25), 255 - (i6 * 25), 255 - (i6 * 25)), 0));
    ...
    public void renderLayerRegion(GraphicsEngine graphicsEngine, float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8, boolean z, boolean z2, boolean z3) {
        ...
        gamePaint5.setAlpha(255);
        if (z4) {
            gamePaint4 = alphaFillPaints[7];
            gamePaint5.setAlpha((int) ((1.0f - ((1.0f - (gamePaint3.getAlpha() / 255.0f)) * (1.0f - (gamePaint4.getAlpha() / 255.0f)))) * 255.0f));
        }
        boolean z5 = false;
            ...
            while (i7 < i4 + 1) {
                ...
                if (mapTile != null) {
                    ...
                    if (b2 != b) {
                        ...
                        rectF.set(f14 - f9, f15 - f10, f16 - f9, f17 - f10);
                        if (z5 && !z3) {
                        ...
                        if (!z3) {
                            ...
                            if (!z6) {
                                ...
                                rect.set((int) (f14 - f9), (int) (f15 - f10), (int) (f16 - f9), (int) (f17 - f10));
                                if (mapTile.atlasSlotIndex >= 0) {
