...
public class ScorchMark extends GameObject {
    ...
    public RectF c() {
        n.left = this.posX - (this.width * 0.5f);
        n.right = this.posX + (this.width * 0.5f);
        n.top = this.posY - (this.height * 0.5f);
        n.bottom = this.posY + (this.height * 0.5f);
        return n;
    }
    ...
    public strictfp void a(final GraphicsEngine y, final int integer2, final int integer3, final float float4) {
        ...
        h.left = (int)(n5 * float4);
        h.top = (int)(n6 * float4);
        h.right = (int)(n7 * float4);
        h.bottom = (int)(n8 * float4);
