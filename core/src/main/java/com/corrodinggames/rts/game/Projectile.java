...
public class Projectile extends PositionedObject {
    ...
    public static Projectile a(BaseUnit baseUnit, float f2, float f3) {
        ...
        projectile.posX = f2;
        projectile.posY = f3;
        projectile.ar = Color.argb(255, 100, 30, 30);
                ...
                if (!this.E) {
                    ...
                    if (z10) {
                        ...
                        if (this.D && projectileTemplate.aX == null) {
                            ...
                            Effect effectCreateLightEffect = gameEngine.effectManager.createLightEffect(this.aV, this.aW, this.posZ, Color.argb(255, 255, 255, 255));
                            ...
                            gameEngine.effectManager.setOverrideEffectQuality(EffectQuality.critical);
                            Effect effectCreateLightEffect2 = gameEngine.effectManager.createLightEffect(this.aV, this.aW, this.posZ, Color.argb(255, 255, 255, 255));
                            ...
                            gameEngine.effectManager.setOverrideEffectQuality(EffectQuality.critical);
                            Effect effectCreateLightEffect3 = gameEngine.effectManager.createLightEffect(this.aV, this.aW, this.posZ, Color.argb(255, 255, 244, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_TV_DATA_SERVICE));
                            ...
                            for (int i3 = 0; i3 < 1; i3++) {
                                gameEngine.effectManager.setOverrideEffectQuality(EffectQuality.critical);
                                Effect effectCreateLightEffect4 = gameEngine.effectManager.createLightEffect(this.aV, this.aW, this.posZ, Color.argb(255, 255, 244, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_TV_DATA_SERVICE));
                            ...
                            gameEngine.effectManager.setOverrideEffectQuality(EffectQuality.critical);
                            Effect effectCreateLightEffect5 = gameEngine.effectManager.createLightEffect(this.aV, this.aW, this.posZ, Color.argb(255, 255, 255, 255));
                            ...
                            gameEngine.effectManager.setOverrideEffectQuality(EffectQuality.critical);
                            Effect effectCreateLightEffect6 = gameEngine.effectManager.createLightEffect(this.aV, this.aW, this.posZ, Color.argb(255, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_3D_MODE, 255, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_TV_SATELLITE_CS));
                            ...
                            gameEngine.effectManager.setOverrideEffectQuality(EffectQuality.critical);
                            Effect effectCreateLightEffect7 = gameEngine.effectManager.createLightEffect(this.aV, this.aW, this.posZ, Color.argb(255, 255, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_TV_ANTENNA_CABLE, 129));
                            ...
                            gameEngine.effectManager.setOverrideEffectQuality(EffectQuality.critical);
                            Effect effectCreateLightEffect8 = gameEngine.effectManager.createLightEffect(this.aV, this.aW, this.posZ, Color.argb(245, 255, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_AVR_INPUT, 110));
                            ...
                            for (int i4 = 0; i4 < 4; i4++) {
                                gameEngine.effectManager.setOverrideEffectQuality(EffectQuality.critical);
                                Effect effectCreateLightEffect9 = gameEngine.effectManager.createLightEffect(this.aV, this.aW, this.posZ, Color.argb(SlickToAndroidKeycodes.AndroidCodes.KEYCODE_PAIRING, 255, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_TV_ANTENNA_CABLE, 129));
                            ...
                            for (int i5 = 0; i5 < 2; i5++) {
                                gameEngine.effectManager.setOverrideEffectQuality(EffectQuality.critical);
                                Effect effectCreateLightEffect10 = gameEngine.effectManager.createLightEffect(this.aV, this.aW, this.posZ, Color.argb(SlickToAndroidKeycodes.AndroidCodes.KEYCODE_PROG_YELLOW, 255, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_TV_ANTENNA_CABLE, 129));
                            ...
                            for (int i6 = 0; i6 < 4; i6++) {
                                ...
                                if (effectCreateLightEffect11 != null) {
                                    ...
                                    effectCreateLightEffect11.x = Color.argb(175, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_TV_TERRESTRIAL_ANALOG, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_TV_TERRESTRIAL_ANALOG, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_TV_TERRESTRIAL_ANALOG);
                            ...
                            for (int i7 = 0; i7 < 2; i7++) {
                                ...
                                if (effectCreateLightEffect12 != null) {
                                    ...
                                    effectCreateLightEffect12.x = Color.argb(105, 115, 115, 115);
    ...
    public boolean a(GameEngine gameEngine) {
        if (gameEngine.cameraFollowSpeed.contains(this.posX, this.posY)) {
            return true;
        }
        if ((this.B || this.E || this.g.X) && this.l != null && gameEngine.cameraFollowSpeed.contains(this.l.posX, this.l.posY)) {
            return true;
        }
        return false;
    }
    ...
    public boolean c(float f2) {
        ...
        if (this.E || projectileTemplate.X) {
            if (projectileTemplate.Y != null) {
                ...
                graphicsEngine.k();
                f.set(f13 - projectileTemplate.Y.r, f14 - fDistance, f13 + projectileTemplate.Y.r, f14 + fDistance);
    ...
    public GamePaint a(int i) {
        ...
        gamePaint.setColorFilter(new LightingColorFilter(i, 0));
