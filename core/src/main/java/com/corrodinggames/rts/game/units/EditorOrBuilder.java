...
public class EditorOrBuilder extends LandUnit implements UnitPathPoints {
    ...
    public EditorOrBuilder(boolean z2) {
        ...
        targetPointPaints.setARGB(40, 0, 255, 0);
        targetPointPaints.setAntiAlias(true);
        targetPointPaints.setStrokeWidth(2.0f);
        targetPointPaints.setStrokeCap(Paint.Cap.ROUND);
        editorSelectionPaint = new Paint();
        editorSelectionPaint.set(targetPointPaints);
        editorSelectionPaint.setARGB(55, 255, 60, 60);
        editorSelectionTexture = new Paint();
        editorSelectionTexture.setARGB(60, 255, 255, 255);
        this.E = null;
