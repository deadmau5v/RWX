...
public abstract class BaseUnit extends SizedObject {
    ...
    public static Texture attackUnit(Texture texture, int i, int i2) {
        ...
        for (int i3 = 0; i3 < iM; i3++) {
            for (int i4 = 0; i4 < iL; i4++) {
                textureA.a(i3, i4, Color.argb(Color.alpha(texture.a(i3, i4)), 0, 0, 0));
            }
        }
        textureA.p();
        textureA.s();
    ...
    static {
        bI.setAntiAlias(true);
        bI.setARGB(255, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_BUTTON_8, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_BUTTON_8, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_BUTTON_8);
        bJ = new GamePaint();
        bJ.setAntiAlias(true);
        bK = new LightingColorFilter(Color.rgb(255, 255, 255), Color.rgb(100, 100, 100));
        bJ.setARGB(255, 255, 255, 255);
        bJ.setColorFilter(bK);
        cW = new Paint();
        cX = new GamePaint();
        cY = new GamePaint();
        cZ = new GamePaint();
        ...
        dj = new GamePaint();
        dk = new Paint();
        cW.setStyle(Paint.Style.STROKE);
        cW.setStrokeWidth(2.0f);
        setPosition(cW);
        cX.setARGB(SlickToAndroidKeycodes.AndroidCodes.KEYCODE_STB_INPUT, 0, 255, 0);
        cX.setStyle(Paint.Style.STROKE);
        cX.setStrokeWidth(2.0f);
        takeDamage(cX, true);
        cY.setARGB(SlickToAndroidKeycodes.AndroidCodes.KEYCODE_STB_INPUT, 0, 255, 0);
        cY.setStyle(Paint.Style.STROKE);
        cY.setStrokeWidth(2.0f);
        setPosition(cY);
        cZ.setARGB(130, 0, 255, 0);
        cZ.setStyle(Paint.Style.STROKE);
        cZ.setStrokeWidth(2.0f);
        setPosition(cZ);
        dd.setARGB(70, 0, 255, 0);
        dd.setStyle(Paint.Style.STROKE);
        dd.setStrokeWidth(1.0f);
        setPosition(dd);
        da.setARGB(SlickToAndroidKeycodes.AndroidCodes.KEYCODE_STB_INPUT, 255, 0, 0);
        da.setStyle(Paint.Style.STROKE);
        da.setStrokeWidth(2.0f);
        setPosition(da);
        de.setARGB(70, 255, 0, 0);
        de.setStyle(Paint.Style.STROKE);
        de.setStrokeWidth(1.0f);
        setPosition(de);
        dc.setARGB(SlickToAndroidKeycodes.AndroidCodes.KEYCODE_STB_INPUT, 255, 255, 0);
        dc.setStyle(Paint.Style.STROKE);
        dc.setStrokeWidth(2.0f);
        setPosition(dc);
        df.setARGB(70, 255, 255, 0);
        df.setStyle(Paint.Style.STROKE);
        df.setStrokeWidth(1.0f);
        setPosition(df);
        db.setARGB(SlickToAndroidKeycodes.AndroidCodes.KEYCODE_STB_INPUT, 255, 255, 255);
        db.setStyle(Paint.Style.STROKE);
        db.setStrokeWidth(2.0f);
        setPosition(db);
        dg.setARGB(90, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_TV_TERRESTRIAL_ANALOG, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_TV_TERRESTRIAL_ANALOG, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_TV_TERRESTRIAL_ANALOG);
        dg.setStyle(Paint.Style.STROKE);
        dg.setStrokeWidth(1.0f);
        setPosition(dg);
        dh.setARGB(100, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_TV_TERRESTRIAL_ANALOG, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_TV_TERRESTRIAL_ANALOG, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_TV_TERRESTRIAL_ANALOG);
        dh.setStyle(Paint.Style.STROKE);
        dh.setStrokeWidth(2.0f);
        setPosition(dh);
        di.setARGB(90, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_TV_TERRESTRIAL_ANALOG, 0, 0);
    ...
    public void a(float f, boolean z) {
        ...
        if (this.isSelected || gameEngine.settingsEngine.showHp) {
            if (x() >= 0.0f) {
                ...
                if (!z4) {
                    ...
                    dr.set(f4 - f3, f5 + f6, (f4 - f3) + (f7 * x()), f5 + f6 + i2);
                    gameEngine.graphicsEngine2.a(dr, paintA);
                    dr.set(f4 - f3, f5 + f6, (f4 - f3) + f7, f5 + f6 + i2);
                    ...
                    if (this.cC != 0.0f && bU() && gameEngine.settingsEngine.showHpChanges) {
                        ...
                        dr.set((f4 - f3) + (f7 * fX), f5 + f6, (f4 - f3) + (f7 * f9), f5 + f6 + i2);
            ...
            if (transportedUnitsWeight >= 0) {
                ...
                for (int i3 = 1; i3 <= maxTransportWeight; i3++) {
                    ...
                    dr.set(f14, f5 + f6 + 3.0f, f14 + f13, f5 + f6 + 3.0f + 3.0f);
        ...
        if (getUnitTeamData() >= 0.0f) {
            ...
            dr.set(f4 - f3, f5 + f6 + i4 + f8, (f4 - f3) + (f7 * getUnitTeamData()), f5 + f6 + i4 + 2 + f8);
            ...
            dr.set(f4 - f3, f5 + f6 + i4 + f8, (f4 - f3) + f7, f5 + f6 + i4 + 2 + f8);
            if (zIsUnitAtPositionX) {
        ...
        if (bV() >= 0.0f) {
            int i5 = i + 1;
            dr.set(f4 - f3, f5 + f6 + i5 + f8, (f4 - f3) + (f7 * bV()), f5 + f6 + i5 + i + f8);
            gameEngine.graphicsEngine2.a(dr, GameViewUtils.a(200, 0, 0, 150, Paint.Style.FILL));
            dr.set(f4 - f3, f5 + f6 + i5 + f8, (f4 - f3) + f7, f5 + f6 + i5 + i + f8);
    ...
    public void O() {
            ...
            for (int i = 0; i < waypointCount; i++) {
                ...
                if (waypointAt != null) {
                    if (GameEngine.isPC()) {
                        ...
                        ds.setStrokeWidth(0.0f);
                    }
                    if (waypointAt.getCommandType() == UnitCommandType.attack) {
                        ds.setColor(Color.argb(160, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_STB_INPUT, 0, 0));
                    } else if (waypointAt.getCommandType() == UnitCommandType.attackMove) {
                        ds.setColor(Color.argb(160, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_STB_INPUT, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_STB_INPUT, 0));
                    } else if (waypointAt.getCommandType() == UnitCommandType.build || waypointAt.getCommandType() == UnitCommandType.repair) {
                        ds.setColor(Color.argb(160, 0, 0, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_STB_INPUT));
                    } else if (waypointAt.getCommandType() == UnitCommandType.loadInto || waypointAt.getCommandType() == UnitCommandType.loadUp) {
                        ds.setColor(Color.argb(160, 0, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_STB_INPUT, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_STB_INPUT));
                    } else if (waypointAt.getCommandType() == UnitCommandType.reclaim) {
                        ds.setColor(Color.argb(160, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_STB_INPUT, 0, 42));
                    } else if (waypointAt.getCommandType() == UnitCommandType.guard || waypointAt.getCommandType() == UnitCommandType.guardAt) {
                        ds.setColor(Color.argb(160, 97, 20, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_LAST_CHANNEL));
                    } else if (waypointAt.getCommandType() == UnitCommandType.patrol) {
                        ds.setColor(Color.argb(160, 0, 210, 210));
                        if (unitCommand == null) {
                        ...
                        ds.setColor(Color.argb(160, 0, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_STB_INPUT, 0));
                    }
                    ...
                    if (0 != 0) {
                        ...
                        dr.set(fFastCos - 1.0f, fFastSin - 1.0f, fFastCos + 1.0f, fFastSin + 1.0f);
                        dr.offset(-gameEngine.viewpointXSnapped, -gameEngine.viewpointYSnapped);
        ...
        if (unitCommand != null && unitCommand2 != null && unitCommand != unitCommand2) {
            ds.setColor(Color.argb(50, 0, 210, 210));
        ...
        if (this.isSelected || z) {
            ...
            if (dp()) {
                ...
                if (playerTeam == this.team) {
                    ...
                    cW.setColor(PlayerTeam.i(this.team.teamColorId));
                    paint = cW;
                } else {
                    paint = dc;
                }
                ...
                if (bI()) {
                    ...
                    if (unitAIUpdateTime != null) {
                        dr.set(unitAIUpdateTime);
                        dr.top *= gameEngine.tileMap.tileWorldSizeY;
                        dr.bottom *= gameEngine.tileMap.tileWorldSizeY;
                        dr.left *= gameEngine.tileMap.tileWorldSizeX;
                        dr.right *= gameEngine.tileMap.tileWorldSizeX;
                        float unitAIPathfindError = getUnitAIPathfindError();
                        dr.offset(-(getUnitAIState() - gameEngine.tileMap.halfTileWorldSizeX), -(getUnitAIPathfindStatus() - gameEngine.tileMap.halfTileWorldSizeY));
                        Utility.grow(dr, unitAIPathfindError);
                        dr.offset(f2, f3);
                        gameEngine.graphicsEngine2.a(dr.left - 11.0f, dr.top, dr.right + 11.0f, dr.top, paint);
                        gameEngine.graphicsEngine2.a(dr.left - 11.0f, dr.bottom, dr.right + 11.0f, dr.bottom, paint);
                        gameEngine.graphicsEngine2.a(dr.left, dr.top - 11.0f, dr.left, dr.bottom + 11.0f, paint);
                        gameEngine.graphicsEngine2.a(dr.right, dr.top - 11.0f, dr.right, dr.bottom + 11.0f, paint);
                        return;
                    }
                    return;
                }
    ...
    public boolean a(GameEngine gameEngine) {
        if (!gameEngine.cameraFollowSpeed.contains(this.posX, this.posY) || this.unitTransportTarget != null) {
            return false;
        }
    ...
    public boolean heal(RectF rectF) {
        if (this.posX + this.radius > rectF.left && this.posX - this.radius < rectF.right && this.posY + this.radius > rectF.top && this.posY - this.radius < rectF.bottom) {
            return true;
        }
        return false;
    }
    ...
    public RectF getUnitMassBounds() {
        ...
        dA.set((this.posX - (this.eu * maxHealth)) - gameEngine.viewpointXSnapped, (this.posY - (this.ev * maxHealth)) - gameEngine.viewpointYSnapped, (this.posX + (this.eu * maxHealth)) - gameEngine.viewpointXSnapped, (this.posY + (this.ev * maxHealth)) - gameEngine.viewpointYSnapped);
        return dA;
    }
    ...
    public RectF getUnitBounds() {
        ...
        float f3 = this.eu;
        float f4 = this.ev;
        rectF.left = (this.posX - f3) - f;
        rectF.right = (this.posX + f3) - f;
        rectF.top = (this.posY - f4) - f2;
        rectF.bottom = (this.posY + f4) - f2;
        return rectF;
    }
    ...
    public Rect a(boolean z, int i) {
        int i2 = 0 + (i * this.es);
        dC.set(i2, 0, i2 + this.es, 0 + this.et);
        return dC;
    }
    ...
    public PointF a(float f, float f2, float f3, float f4, float f5) {
        ...
        dD.set(pointFCalculateMaxAttackRange2);
        return dD;
    }

    /* JADX INFO: renamed from: m */
    PointF calculateMaxAttackRange(float f) {
        dE.set(this.posX + (this.velocityX * f), this.posY + (this.velocityY * f));
        return dE;
    }
    ...
    public Point a(TileMap tileMap, Point point) {
        point.x = (int) (((this.posX - getUnitAIState()) + 1.0f) * tileMap.tileScaleX);
        point.y = (int) (((this.posY - getUnitAIPathfindStatus()) + 1.0f) * tileMap.tileScaleY);
        return point;
    }
    ...
    public RectF a(TileMap tileMap, RectF rectF) {
        ...
        Rect rectCd = cd();
        rectF.set(f + (rectCd.left * tileMap.tileWorldSizeX), f2 + (rectCd.top * tileMap.tileWorldSizeY), f + ((rectCd.right + 1) * tileMap.tileWorldSizeX), f2 + ((rectCd.bottom + 1) * tileMap.tileWorldSizeY));
        return rectF;
    }
