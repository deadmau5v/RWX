...
public class MissionEngine extends Serializable {
        ...
        if (mapObjectLayer != null) {
            for (MapObject mapObject : mapObjectLayer.mapObjects) {
                if ("point".equalsIgnoreCase(mapObject.type) && mapObject.normalizedName != null && mapObject.normalizedName.equalsIgnoreCase(str)) {
                    this.K.set(mapObject.x, mapObject.y);
                    return this.K;
                }
            }
            return null;
    ...
    public void b(final float float1) {
        ...
        if (this.k && !this.N) {
            ...
            if (b) {
                if (b2) {
                    final int n3 = (int)(23.0f + this.E.getTextSize() / 2.0f);
                    instance.graphicsEngine2.a("- Wave " + this.r + " -", instance.currentScreenWidthPixels / 2.0f, (float)n3, this.E);
                    if (this.s != null) {
                        instance.graphicsEngine2.a(this.s, instance.currentScreenWidthPixels / 2.0f, n3 + this.E.getTextSize() + 2.0f, this.F);
                    }
                }
                else {
                    final int n3 = (int)(23.0f + this.G.getTextSize() / 2.0f);
                    ...
                    instance.graphicsEngine2.a(this.t, instance.currentScreenWidthPixels / 2.0f, n3 + this.G.getTextSize() + 2.0f, this.H);
                }
            }
        }
        if (this.k && this.N) {
            ...
            if (d != null) {
                ...
                final String f = d.f;
                if (f != null) {
                    instance.graphicsEngine2.a(f, instance.currentScreenWidthPixels / 2.0f, n3 + this.G.getTextSize() + 2.0f, this.H);
                }
            }
        }
    }
    ...
    public void e() {
        this.R = true;
        this.P.set((PointF) this.D.get(Utility.getDeterministicRandomIntInRange(0, this.D.size() - 1, this.r)));
    }
