...
public class Texture {
    ...
    public Texture clone() {
        ...
        texture.o = this.o;
        if (this.k != null) {
            Bitmap bitmapA = this.k.copy(this.k.getConfig(), true);
            if (bitmapA == null) {
    ...
    public Texture a(int i, int i2, boolean z) {
        ...
        texture.o = this.o;
        if (this.k != null) {
            Bitmap bitmapA = Bitmap.createBitmap(i, i2, this.k.getConfig());
            texture.a(bitmapA);
            if (z) {
                for (int i3 = 0; i3 < bitmapA.getWidth(); i3++) {
                    for (int i4 = 0; i4 < bitmapA.getHeight(); i4++) {
                        bitmapA.setPixel(i3, i4, this.k.getPixel(i3, i4));
                    }
                }
            }
        }
