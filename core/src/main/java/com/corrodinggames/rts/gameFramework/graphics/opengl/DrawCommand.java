...
public class DrawCommand {
    ...
    public void a(GL10 gl10) {
        ...
        if (this.a == ShapeType.Rect) {
            gl10.glTranslatef(this.f.left, (this.g.c - this.f.top) - this.e.height(), 0.0f);
            GLMeshBuffer gLMeshBuffer = this.g.h;
            float fM = this.e.left / this.b.m();
            float fM2 = this.e.right / this.b.m();
            float fL = this.e.top / this.b.l();
            float fL2 = this.e.bottom / this.b.l();
            if (this.g.j == this.e.height() && this.g.k == this.e.width()) {
                gLMeshBuffer.a(0, 0, fM, fL2);
                gLMeshBuffer.a(1, 0, fM2, fL2);
                gLMeshBuffer.a(0, 1, fM, fL);
                gLMeshBuffer.a(1, 1, fM2, fL);
            } else {
                this.g.j = this.e.height();
                this.g.k = this.e.width();
                gLMeshBuffer.a(0, 0, 0.0f, 0.0f, 0.0f, fM, fL2, null);
                gLMeshBuffer.a(1, 0, this.e.width(), 0.0f, 0.0f, fM2, fL2, null);
                gLMeshBuffer.a(0, 1, 0.0f, this.e.height(), 0.0f, fM, fL, null);
                gLMeshBuffer.a(1, 1, this.e.width(), this.e.height(), 0.0f, fM2, fL, null);
            }
