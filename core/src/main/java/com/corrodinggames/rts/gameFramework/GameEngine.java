...
public abstract class GameEngine {
    ...
    private boolean[] graphicsSettings = new boolean[KeyEvent.getMaxKeyCode() + 1];

    /* JADX INFO: renamed from: d */
    private boolean[] uiSettings = new boolean[KeyEvent.getMaxKeyCode() + 1];
    ...
    public static boolean centerCameraOnPosition(Context context) {
        ...
        if (isPausedStatic2) {
            ...
            strH = String.valueOf(context.getResources().getDisplayMetrics().heightPixels);
        }
    ...
    public void setViewpoint(float f, float f2) {
        ...
        this.cameraFollowTarget.set((int) (this.viewpointX - i), (int) (this.viewpointY - i), (int) (this.viewpointX + this.screenHeight + i), (int) (this.viewpointY + this.viewpointHeight + i));
        this.cameraFollowSpeed.set(this.cameraFollowTarget);
        this.cameraSmoothing.set((int) this.viewpointX, (int) this.viewpointY, (int) (this.viewpointX + this.screenHeight), (int) (this.viewpointY + this.viewpointHeight));
        this.cameraFollowZoom.set((int) (this.viewpointX - 300), (int) (this.viewpointY - 300), (int) (this.viewpointX + this.screenHeight + 300), (int) (this.viewpointY + this.viewpointHeight + 300));
    }
    ...
    public void getTouchY(Paint paint, float f) {
        ...
        if (paint.getTextSize() != screenPixels) {
            paint.setTextSize(screenPixels);
        }
    }
    ...
    public void showMessageBox(String str, String str2) {
        ...
        if (isPausedStatic2) {
            ...
            this.keyHandler.post(this.showDialogRunnable);
        }
    }
    ...
    public void alert(String str, int i) {
        if (isPausedStatic2) {
            ...
            this.keyHandler.post(this.showToastRunnable);
        }
        if (this.missionEngine2 != null) {
    ...
    public final boolean handleNetworkPacket(float f, float f2, float f3) {
        return this.cameraFollowMode.left < f + f3 && f - f3 < this.cameraFollowMode.right && this.cameraFollowMode.top < f2 + f3 && f2 - f3 < this.cameraFollowMode.bottom;
    }
