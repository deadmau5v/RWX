...
public final class NetworkEngine {
    ...
    public boolean getAIDifficultyString(PlayerTeam playerTeam) {
        boolean z = false;
        if (playerTeam.isTeamSpectator) {
            String str = "AI - " + b(playerTeam.teamColorId);
    ...
    public void d(String str) {
        Log.d("RustedWarfare", "network:" + str);
    }
    ...
    InetAddress al() {
        try {
            DhcpInfo dhcpInfo = ((WifiManager) GameEngine.getInstance().appContext.getSystemService("wifi")).getDhcpInfo();
    ...
    public void d(String str, String str2) {
        ...
        NotificationManager notificationManager = (NotificationManager) gameEngine.appContext.getSystemService("notification");
    ...
    private void i(int i) {
        ...
        ((NotificationManager) GameEngine.getInstance().appContext.getSystemService("notification")).cancel(i);
    }
