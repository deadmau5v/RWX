...
public class GameInterfaceRenderer extends Serializable {
    ...
    static PorterDuffColorFilter staticColorFilter = new PorterDuffColorFilter(Color.rgb(200, 255, 200), PorterDuff.Mode.MULTIPLY);
    ...
    public void initializeUI() {
        ...
        staticPaint.setARGB(255, 30, 30, 30);
        staticPaint.setColorFilter(staticColorFilter);
        staticPaint.setFilterBitmap(true);
        ...
        this.textPaint2.setARGB(255, 255, 255, 255);
        ...
        this.paint1.setColor(Color.argb(SlickToAndroidKeycodes.AndroidCodes.KEYCODE_BUTTON_3, 255, 255, 255));
        this.paint1.o();
        this.paint2 = new GamePaint();
        this.paint2.setColor(Color.argb(133, 255, 255, 255));
        this.paint2.o();
    ...
    void handleZoomAndGestures(float f) {
        ...
        if (this.gameEngine.settingsEngine.showZoomButton) {
            ...
            if (this.isZoomButtonPressed) {
                this.zoomButtonRect.set(i - 4, (int) (i2 - (50.0f * this.gameEngine.screenScale)), i + 4, (int) (i2 + (50.0f * this.gameEngine.screenScale)));
                this.paintUnitInfo.reset();
                this.paintUnitInfo.setColor(Color.argb(255, 0, 0, 0));
            ...
            this.zoomButtonRect.set((int) (i - f7), (int) (f2 - f8), (int) (i + f7), (int) (f2 + f8));
            if (!this.isZoomButtonPressed) {
                staticPaint.setARGB(140, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_KATAKANA_HIRAGANA, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_KATAKANA_HIRAGANA, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_KATAKANA_HIRAGANA);
            } else {
                staticPaint.setARGB(255, 255, 255, 255);
            }
            this.gameEngine.graphicsEngine2.a(this.zoomButtonTexture, this.zoomButtonRect.left, this.zoomButtonRect.top, staticPaint, 0.0f, f3);
            boolean z = this.isZoomButtonPressed;
            if (!this.isZoomButtonPressed && this.gameUI.b(this.zoomButtonRect.left, this.zoomButtonRect.top, this.zoomButtonRect.centerY(), this.zoomButtonRect.height(), IconGroup.zoomButton)) {
    ...
    void handleUnitSelection(float f) {
        ...
        if (this.gameEngine.isTouchDown() && this.gameUI.currentAction == null) {
            ...
            if (zIsKeyboardSupportAndGraphicsEnabled || (this.gameEngine.settingsEngine.mouseSupport && iIsInDebug != -1 && !this.gameUI.isRightMousePressed && !this.gameUI.isMiddleMousePressed)) {
                ...
                if (!this.isDragging) {
                    z2 = true;
                    this.selectionRectF2.left = (int) touchX;
                    this.selectionRectF2.top = (int) fLogWarning;
                }
                this.selectionRectF2.right = (int) touchX;
                this.selectionRectF2.bottom = (int) fLogWarning;
                if (Math.abs(this.selectionRectF2.left - this.selectionRectF2.right) > i || Math.abs(this.selectionRectF2.top - this.selectionRectF2.bottom) > i) {
                    this.isDraggingSelectionBox = true;
                }
                z = true;
            } else if (this.gameEngine.getTouchPointerCount() == 2 && this.gestureZoomTimer == 0.0f) {
                this.selectionRectF2.left = (int) this.gameEngine.getTouchX(0);
                this.selectionRectF2.top = (int) this.gameEngine.logWarning(0);
                this.selectionRectF2.right = (int) this.gameEngine.getTouchX(1);
                this.selectionRectF2.bottom = (int) this.gameEngine.logWarning(1);
            ...
            if (z) {
                ...
                if (Math.abs(this.selectionRectF2.left - this.selectionRectF2.right) > i || Math.abs(this.selectionRectF2.top - this.selectionRectF2.bottom) > i) {
                    this.selectionRect.bottom = (int) this.selectionRectF2.bottom;
                    this.selectionRect.top = (int) this.selectionRectF2.top;
                    this.selectionRect.left = (int) this.selectionRectF2.left;
                    this.selectionRect.right = (int) this.selectionRectF2.right;
                    Utility.sqrt(this.selectionRect);
                    this.paintSelectionBox.setColor(Color.argb(255, 0, 255, 0));
                    this.paintSelectionBox.setStyle(Paint.Style.STROKE);
                    this.paintSelectionBox.setStrokeWidth(1.0f);
        ...
        if ((z && !z3) || z4) {
            ...
            this.selectionRectF3.set(this.selectionRectF2);
            Utility.sortRect(this.selectionRectF3);
            if (Math.abs(this.selectionRectF3.left - this.selectionRectF3.right) > i || Math.abs(this.selectionRectF3.top - this.selectionRectF3.bottom) > i) {
                this.selectionRectF3.bottom /= this.gameEngine.zoom;
                this.selectionRectF3.top /= this.gameEngine.zoom;
                this.selectionRectF3.left /= this.gameEngine.zoom;
                this.selectionRectF3.right /= this.gameEngine.zoom;
                this.selectionRectF3.offset(this.gameEngine.viewpointXSnapped, this.gameEngine.viewpointYSnapped);
    ...
    private boolean a(UnitBase unitBase) {
        if (!unitBase.isDestroyed && unitBase.unitTransportTarget == null) {
            ...
            if (this.selectionRectF3.contains(f, f2)) {
    ...
    int d(final float float1) {
        ...
        if (baseUnit != null && a.size() > 0) {
            ...
            if (n12 != 0) {
                ...
                this.zoomButtonRect.left = (int)(width + 2.0f);
                this.zoomButtonRect.right = (int)(width + n7 - 2.0f);
                this.zoomButtonRect.top = (int)(currentScreenHeightPixels - h * n17);
                this.zoomButtonRect.bottom = (int)(this.zoomButtonRect.top + h * n17);
                if (this.gameUI.a(this.zoomButtonRect.left, this.zoomButtonRect.top, this.zoomButtonRect.centerY(), this.zoomButtonRect.height(), "\\/", IconGroup.none, false, Color.argb(80, 100, 150, 100), this.gameUI.buildingPreviewPaint, null) && this.gameUI.isInputEnabled()) {
                    n16 += 3.0f * n6;
                    this.gameUI.isSelectionBoxActive = false;
                }
            ...
            if (b4) {
                ...
                this.zoomButtonRect.left = (int)(width + 2.0f);
                this.zoomButtonRect.right = (int)(width + n7 - 2.0f);
                this.zoomButtonRect.top = (int)n14;
                this.zoomButtonRect.bottom = (int)(this.zoomButtonRect.top + h * n17);
                if (this.gameUI.a(this.zoomButtonRect.left, this.zoomButtonRect.top, this.zoomButtonRect.centerY(), this.zoomButtonRect.height(), "/\\", IconGroup.none, false, Color.argb(80, 100, 150, 100), this.gameUI.buildingPreviewPaint, null) && this.gameUI.isInputEnabled()) {
                    n16 -= 3.0f * n6;
                    this.gameUI.isSelectionBoxActive = false;
            ...
            this.rectF.set(0.0f, n14 - 1.0f, this.gameEngine.screenWidth, currentScreenHeightPixels + 1.0f);
            ...
            for (final AbstractUnitAction unitCommand : arrayList) {
                ...
                if (!b2) {
                    this.zoomButtonRect.left = (int)(width + n4);
                    this.zoomButtonRect.right = (int)(this.zoomButtonRect.left + n21 - n4 * 2.0f);
                    this.zoomButtonRect.top = (int)(n19 + y);
                    this.zoomButtonRect.bottom = (int)(this.zoomButtonRect.top + n20);
                    this.zoomButtonRect.offset((int)n9, 0);
                }
                else {
                    this.zoomButtonRect.left = (int)(width + n4 + n19);
                    this.zoomButtonRect.right = (int)(this.zoomButtonRect.left + n21 - n4 * 2.0f);
                    this.zoomButtonRect.top = (int)y;
                    this.zoomButtonRect.bottom = (int)(this.zoomButtonRect.top + n20);
                    this.zoomButtonRect.offset(0, (int)n9);
                }
                boolean b5 = true;
                this.zoomButtonRectF.set(this.zoomButtonRect);
                if (!this.zoomButtonRectF.intersect(this.rectF)) {
                    b5 = false;
                }
                n9 += n23;
                ...
                if (b8) {
                    paint2.setColor(Color.argb(70, 100, 100, 100));
                }
                else {
                    paint2.setColor(Color.argb(50, 170, 100, 100));
                }
                if (a2) {
                    paint2.setColor(Color.argb(100, 180, 100, 100));
                }
                boolean b9 = false;
                boolean b10 = false;
                ...
                if (b9) {
                    paint2.setColor(Color.argb(80, 100, 100, 200));
                }
                if (b10) {
                    paint2.setColor(Color.argb(80, 100, 200, 100));
                }
                GamePaint paint3;
                if (buildOption) {
                    paint2.setAlpha((int)(paint2.getAlpha() * 0.7f));
                    paint3 = this.paint2;
                }
                else {
                    paint3 = this.paint1;
                ...
                if (b5) {
                    ...
                    if (unitCommand.isAlsoSelected() != ActionDisplayType.infoOnlyNoBox) {
                        ...
                        if (timerValue != 0.0f) {
                            ...
                            int n26;
                            if (timerValue > 0.0f) {
                                n26 = Color.argb(110, 210, 210, 210);
                            }
                            else {
                                n26 = Color.argb(110, 210, 110, 110);
                            }
                            final int randomIntInRange = Utility.getRandomIntInRange(n26, paint2.getColor(), n25);
                            paint2 = this.paintUnitInfo;
                            paint2.setColor(randomIntInRange);
                        }
                        this.gameUI.a(this.zoomButtonRect, paint2, paint3);
                        float n25 = this.d(unitCommand, g);
                        if (n25 >= 0.0f) {
                            this.paintUnitTeam.setARGB(80, 0, 0, 100);
                            this.minimapRect.set(this.zoomButtonRect);
                            final Rect minimapRect = this.minimapRect;
                            minimapRect.right -= (int)((1.0f - n25) * this.minimapRect.width());
                            this.gameEngine.graphicsEngine2.b(this.minimapRect, this.paintUnitTeam);
                            this.paintUnitStatus.setARGB(190, 148, 189, 255);
                            this.gameEngine.graphicsEngine2.a((float)this.minimapRect.right, (float)this.minimapRect.top, (float)this.minimapRect.right, (float)this.minimapRect.bottom, this.paintUnitTeam);
                        }
                        else {
                            final float e = this.e(unitCommand);
                            if (e > 0.0f) {
                                this.paintUnitTeam.setARGB(80, 100, 0, 0);
                                this.minimapRect.set(this.zoomButtonRect);
                                final Rect minimapRect2 = this.minimapRect;
                                minimapRect2.right -= (int)((1.0f - e) * this.minimapRect.width());
                                this.gameEngine.graphicsEngine2.b(this.minimapRect, this.paintUnitTeam);
                                this.paintUnitStatus.setARGB(190, 148, 189, 255);
                                this.gameEngine.graphicsEngine2.a((float)this.minimapRect.right, (float)this.minimapRect.top, (float)this.minimapRect.right, (float)this.minimapRect.bottom, this.paintUnitTeam);
                            }
                        }
                        int n26 = Color.argb(255, 0, 0, 0);
                        if (GameUI.bO) {
                            n26 = Color.argb(100, 0, 0, 0);
                            if (buildOption) {
                                n26 = Color.argb(50, 155, 155, 155);
                            }
                        }
                ...
                if (a3 != null && b5) {
                    ...
                    this.gameEngine.graphicsEngine2.a(c2, (float)(this.zoomButtonRect.left + 3), this.zoomButtonRect.top + n25 + 1.0f, this.gameUI.selectionBoxPaint);
                }
                boolean b11 = false;
                ...
                if (e2 != null) {
                    ...
                    this.paintMinimap.setARGB(100, 255, 255, 255);
                    final RectF minimapRectF = this.minimapRectF;
                    minimapRectF.set((float)n27, (float)a4, n27 + rect.width() * float2, a4 + rect.height() * float2);
                    ...
                    this.selectionRectF.set(this.zoomButtonRect);
                    if (this.selectionRectF.intersect(this.rectF)) {
                        this.gameEngine.graphicsEngine2.i();
                        ...
                        if (showingNotEnoughResources != null) {
                            ...
                            if (bv != -1.0f && unitCommand.shouldShowCount(baseUnit)) {
                                ...
                                final int n33 = 0;
                                final int n34 = n32 * 2;
                                this.minimapRectF.set(float3 - n32, float2 + n33, float3 - n32 + n34 * bv, float2 + n33 + n31);
                                this.gameEngine.graphicsEngine2.a(this.minimapRectF, a5);
                                this.minimapRectF.set(float3 - n32, float2 + n33, float3 - n32 + n34, float2 + n33 + n31);
                                ...
                                final int n33 = 0;
                                final int n34 = n32 * 2;
                                this.minimapRectF.set(float3 - n32, float2 + n33, float3 - n32 + n34 * n28, float2 + n33 + n31);
                ...
                if (showingNotEnoughEnergy != null) {
                    ...
                    if (rect2 == null) {
                        ...
                        rect2.set(0, 0, showingNotEnoughEnergy.m(), showingNotEnoughEnergy.l());
                    }
                    ...
                    this.paintMinimap.setColor(unitCommand.getNotAvailableReason());
                    final RectF minimapRectF2 = this.minimapRectF;
                    minimapRectF2.set((float)a4, (float)n35, a4 + rect2.width() * float4, n35 + rect2.height() * float4);
                ...
                if (b5) {
                    ...
                    if (a2) {
                        this.gameEngine.graphicsEngine2.a(this.lockIconTexture, (float)(this.zoomButtonRect.left + 25), this.zoomButtonRect.exactCenterY(), null);
                    }
                    final float float4 = (float)this.gameEngine.graphicsEngine2.b(d, this.gameUI.buildingPreviewPaint);
                    if (float4 > this.zoomButtonRect.centerY() - 2) {
                        final float float5 = (float)this.gameEngine.graphicsEngine2.b(d, this.gameUI.rallyPointPaint);
                        if (float5 > this.zoomButtonRect.centerY() - 2) {
                            this.paintUnitInfo.set(this.gameUI.selectionBoxBorderPaint);
                        }
                        else {
                            this.paintUnitInfo.set(this.gameUI.rallyPointPaint);
                        }
                    }
                    else {
                        this.paintUnitInfo.set(this.gameUI.buildingPreviewPaint);
                    }
                    if (!b8) {
                        this.paintUnitInfo.setColor(Color.argb(255, 0, 100, 0));
                    }
                    if (alsoSelected == ActionDisplayType.rally) {
                        this.paintUnitInfo.setARGB(255, 255, 255, 255);
                    }
                    else if (alsoSelected == ActionDisplayType.upgrade || alsoSelected == ActionDisplayType.action) {
                        if (!b8) {
                            this.paintUnitInfo.setARGB(255, 19, 101, 94);
                        }
                        else {
                            this.paintUnitInfo.setARGB(255, 39, 202, 189);
                        }
                    }
                        ...
                        if (unitType != null && unitType.g() > 1) {
                            if (!b8) {
                                this.paintUnitInfo.setARGB(255, 117, 120, 15);
                            }
                            else {
                                this.paintUnitInfo.setARGB(255, 235, 240, 30);
                            }
                        }
                    }
                    else if (b6) {
                        this.paintUnitInfo.setARGB(155, 255, 255, 255);
                    }
                    ...
                    if (b11 && !d.contains((CharSequence)"\n")) {
                        if (b6) {
                            n28 = (float)(this.zoomButtonRect.bottom - a4 / 2 - 1);
                        }
                        else {
                            n28 = (float)(this.zoomButtonRect.bottom - 6);
                        }
                    }
                    if (b6) {
                ...
                this.unitRect.set(this.zoomButtonRect);
                if (GameEngine.isAndroid()) {
                    Utility.grow2(this.unitRect, 2.0f);
                }
                this.gameUI.a((float)this.unitRect.left, (float)this.unitRect.top, (float)this.unitRect.width(), (float)this.unitRect.height());
                if (!this.isDraggingSelectionBox && this.unitRect.contains((int)this.gameUI.selectionBoxMinWidth, (int)this.gameUI.selectionBoxMinHeight) && this.rectF.contains((float)(int)this.gameUI.selectionBoxMinWidth, (float)(int)this.gameUI.selectionBoxMinHeight)) {
                    b = true;
                    if (GameEngine.isPC()) {
                        b12 = true;
                    }
    ...
    void a(float f, int i) {
        ...
        if (this.gameUI.selectedUnitCount > 0) {
            ...
            if (z) {
                if (this.gameUI.b((int) ((this.gameEngine.screenWidth - this.gameEngine.minimap.width) + 2.0f), this.gameEngine.minimap.getBottomY() + 2, (int) (this.gameEngine.minimap.width - 4.0f), (int) i(), this.unselectAllText, IconGroup.unselectAllButton, false, Color.argb(140, 100, 100, 100)) && !this.gameUI.isInputDisabled) {
                    this.gameUI.resetMouseState();
                    this.gameUI.clearCurrentAction();
            ...
            this.zoomButtonRect.set((int) f2, (int) f3, (int) ((f2 + this.gameEngine.sidebarWidth) - (i4 * 2)), (int) (f3 + iH));
            boolean z4 = false;
            if (!GameUI.bQ) {
    ...
    void a(final int integer1, final int integer2, final int integer3, final String string4, final String string5, final Paint paint, final float float7) {
        ...
        this.rect.set(n - integer4 / 2, integer6, integer4, integer5);
        this.gameUI.a(this.rect.left, this.rect.top, this.rect.right, this.rect.bottom, "", Color.argb(180, 100, 100, 100), this.gameUI.buildingPreviewPaint, false, null, null);
        this.zoomButtonRect.set(this.rect.left, this.rect.top, this.rect.right, this.rect.bottom);
        final Rect zoomButtonRect = this.zoomButtonRect;
        zoomButtonRect.right *= (int)float7;
    ...
    void a(final float float1, final boolean boolean2) {
        ...
        if (this.gameUI.isDraggingSelection) {
            ...
            this.paintHealthBar.setAlpha(150 + (int)(100.0f * Utility.fastSin(this.infoTextTimer * 180.0f)));
        }
        else {
            this.infoTextTimer = 0.0f;
            this.paintHealthBar.setAlpha(80);
        }
        this.unitRect2.set(n3, n4, n3 + n2, n4 + n2);
        this.unitRect2.offset(-(n2 / 2), -(n2 / 2));
        if (boolean2) {
            this.gameEngine.graphicsEngine2.a(this.pauseTexture, (float)this.unitRect2.left, (float)this.unitRect2.top, this.paintHealthBar, 0.0f, float2);
            if (this.gameEngine.settingsEngine.newRender) {
                this.minimapRect.set(this.unitRect2.centerX() - 4, this.unitRect2.centerY() - 4, this.unitRect2.centerX() + 4, this.unitRect2.centerY() + 4);
                this.paintMinimap.setARGB(100, 0, 155, 0);
        ...
        if (this.gameUI.isSelectionBoxActive && !this.gameUI.isInputDisabled && this.unitRect2.contains((int)this.gameUI.selectionBoxStartX, (int)this.gameUI.selectionBoxStartY)) {
            this.gameUI.isSelectionBoxActive = false;
            this.gameUI.isDraggingSelection = !this.gameUI.isDraggingSelection;
        }
        ...
        if (this.gameEngine.replayEngine.j()) {
            ...
            if (this.gameEngine.replayEngine.v != 1) {
                this.paintHealthBar.setAlpha(200);
            }
            ...
            n3 += n2 / 2 + 5;
            this.unitRect2.set(n3, n4, n3 + n2, n4 + n2);
            this.unitRect2.offset(-this.unitRect2.width() / 2, -this.unitRect2.height() / 2);
            if (boolean2) {
                this.gameEngine.graphicsEngine2.a(this.fastTexture, (float)this.unitRect2.left, (float)this.unitRect2.top, this.paintHealthBar, 0.0f, (float)(n2 / n));
            }
            if (this.gameUI.isSelectionBoxActive && !this.gameUI.isInputDisabled && this.unitRect2.contains((int)this.gameUI.selectionBoxStartX, (int)this.gameUI.selectionBoxStartY)) {
                this.gameUI.isSelectionBoxActive = false;
            ...
            this.unitRect2.offset(-this.unitRect2.width() / 2, -this.unitRect2.height() / 2);
            if (boolean2) {
                this.gameEngine.graphicsEngine2.a(replayPauseTexture, (float)this.unitRect2.left, (float)this.unitRect2.top, this.paintHealthBar, 0.0f, (float)(n2 / n));
            }
            if (this.gameUI.isSelectionBoxActive && !this.gameUI.isInputDisabled && this.unitRect2.contains((int)this.gameUI.selectionBoxStartX, (int)this.gameUI.selectionBoxStartY)) {
                this.gameUI.isSelectionBoxActive = false;
            ...
            this.unitRect2.offset(-this.unitRect2.width() / 2, -this.unitRect2.height() / 2);
            if (boolean2) {
                this.gameEngine.graphicsEngine2.a(leaderboardTexture, (float)this.unitRect2.left, (float)this.unitRect2.top, this.paintHealthBar, 0.0f, (float)(n2 / n));
            }
            if (this.gameUI.isSelectionBoxActive && !this.gameUI.isInputDisabled && this.unitRect2.contains((int)this.gameUI.selectionBoxStartX, (int)this.gameUI.selectionBoxStartY)) {
        ...
        if (this.gameUI.isDraggingSelection) {
            ...
            this.zoomButtonRect.left = (int)(this.gameEngine.currentScreenWidthPixels / 2.0f - screenPixels / 2);
            this.zoomButtonRect.right = (int)(this.gameEngine.currentScreenWidthPixels / 2.0f + screenPixels / 2);
            ...
            this.zoomButtonRect.top = (int)(this.gameEngine.halfScreenHeight - n6 / 2);
            this.zoomButtonRect.bottom = (int)(this.gameEngine.halfScreenHeight + n6 / 2);
            if (boolean2) {
                this.gameUI.ninePatchStyle5.c(this.gameEngine.graphicsEngine2, this.zoomButtonRect);
            }
            final int n7 = this.zoomButtonRect.top + this.gameEngine.toScreenPixels(40);
            ...
            int n9 = n7;
            final int a = Color.argb(140, 100, 100, 100);
    ...
    Menu o() {
        ...
        surfaceHolder.onCreateOptionsMenu(this.vObject);
        return this.vObject;
    }
        ...
        for (int i5 = 0; i5 < this.arrayList.size(); i5++) {
            ...
            if (this.gameEngine.settingsEngine.showUnitGroups && i5 < 3) {
                ...
                if (this.gameUI.a(i2, i, i4, (int) (31.0f * this.gameEngine.screenScale), str, IconGroup.none, true, Color.a(50, (int) (100.0f + (unitGroupMarker.f * 100.0f)), (int) (100.0f + (unitGroupMarker.e * 100.0f)), (int) (100.0f + (unitGroupMarker.d * 100.0f)))) && this.gameUI.currentAction == null && !this.gameUI.isInputDisabled) {
                    ...
                    float f2 = 1.0f;
                    this.paintUnitInfo.reset();
                    this.paintUnitInfo.setColor(Color.argb(120, 200, 0, 0));
                    if (unitGroupMarker.b < 50.0f) {
                        f2 = unitGroupMarker.b / 50.0f;
                        this.paintUnitInfo.setColor(Color.argb((int) (150.0f + (f2 * 40.0f)), 0, 200, 0));
                        ...
                        this.paintUnitInfo.setColor(Color.argb((int) (150.0f + (f2 * 40.0f)), 200, 0, 0));
                    ...
                    this.zoomButtonRect.set(i2, (int) ((i + i6) - (i6 * f2)), i2 + i4, i + i6);
                    this.gameEngine.graphicsEngine2.b(this.zoomButtonRect, this.paintUnitInfo);
                }
                if (!z) {
