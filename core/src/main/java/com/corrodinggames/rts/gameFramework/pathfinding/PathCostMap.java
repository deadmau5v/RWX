...
public final class PathCostMap {
    ...
    strictfp void b(OrderableUnit var_1_21) {
        ...
        if (var_1_21 != null) {
            ...
            n = (short)(short3 - 5 + cc.left);
            n2 = (short)(n5 - 5 + cc.top);
            n3 = (short)(short3 + 5 + cc.right);
            n4 = (short)(n5 + 5 + cc.bottom);
        }
        if (n < 0) {
            n = 0;
        }
    ...
    public void c(OrderableUnit orderableUnit) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (baseUnit.bI() && !baseUnit.isDestroyed) {
                ...
                for (int i4 = i2 + rectCc.left; i4 <= i2 + rectCc.right; i4++) {
                    for (int i5 = i3 + rectCc.top; i5 <= i3 + rectCc.bottom; i5++) {
