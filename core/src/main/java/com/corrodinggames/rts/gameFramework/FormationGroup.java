...
public class FormationGroup {
    ...
    public void c() {
        ...
        PerformanceProfiler.a();
        a();
        this.formationEngine.b.set(0.0f, 0.0f);
        for (OrderableUnit orderableUnit : this.units) {
            this.formationEngine.b.offset(orderableUnit.posX, orderableUnit.posY);
        }
        this.formationEngine.b.set(this.formationEngine.b.x / this.units.size(), this.formationEngine.b.y / this.units.size());
