        ...
        for (int i8 = i4; i8 < i6 + 1; i8++) {
            for (int i9 = i5; i9 < i7 + 1; i9++) {
                if (mapLayer.getTileAt(i8, i9) != null) {
                    ...
                    rect.set(i10, i11, i10 + tileMap.tileWorldSizeX, i11 + tileMap.tileWorldSizeY);
                    rect.offset((int) (-f), (int) (-f2));
                    boolean zB = rect.contains((int) (gameEngine.gameUI.selectionBoxStartX / gameEngine.zoom), (int) (gameEngine.gameUI.selectionBoxStartY / gameEngine.zoom));
                    int i12 = 0;
                    if (50 == -1) {
                        i = 255;
                    } else {
                    ...
                    c.setARGB(128, i, i2, i3);
                    a(a(i8, i9), d);
                    float f5 = (i10 + tileMap.halfTileWorldSizeX) - f;
                    float f6 = (i11 + tileMap.halfTileWorldSizeY) - f2;
                    gameEngine.graphicsEngine2.a(f5, f6, f5 + (d.x * (tileMap.tileWorldSizeX - 3)) + 1.0f, f6 + (d.y * (tileMap.tileWorldSizeY - 3)) + 1.0f, c);
                    if (zB) {
                    }
                }
            }
