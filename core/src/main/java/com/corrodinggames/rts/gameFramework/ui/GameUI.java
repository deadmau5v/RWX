...
public final class GameUI extends Serializable {
    ...
    public void initializeUIResources(Context context) {
        ...
        this.tooltipBackgroundPaint.setAntiAlias(true);
        this.tooltipBorderPaint = new Paint();
        this.tooltipBorderPaint.setAntiAlias(true);
        this.tooltipBorderPaint.setARGB(40, 255, 255, 255);
        ...
        UIStyle.b();
        this.bE.setARGB(145, 0, 175, 0);
        this.bE.setStrokeWidth(6.0f);
        GamePaint.b(this.bE);
        this.bD.setAntiAlias(true);
        this.unitHealthBarPaint = new Paint();
        this.unitHealthBarBackgroundPaint = new GamePaint();
        this.unitHealthBarBackgroundPaint.setARGB(255, 0, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_TV_SATELLITE_SERVICE, 0);
        this.unitHealthBarBackgroundPaint.setAntiAlias(true);
        this.unitHealthBarBackgroundPaint.setSubpixelText(true);
        this.unitHealthBarBackgroundPaint.setTypeface(Typeface.create(Typeface.DEFAULT, Typeface.BOLD));
        gameEngine.updatePaintTextSize(this.unitHealthBarBackgroundPaint, 20.0f);
        this.unitHealthBarBackgroundPaint.setTextAlign(Paint.Align.LEFT);
        this.unitSelectionBorderPaint = new GamePaint();
        this.unitSelectionBorderPaint.setARGB(255, 0, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_TV_SATELLITE_SERVICE, 0);
        this.unitSelectionBorderPaint.setAntiAlias(true);
        this.unitSelectionBorderPaint.setSubpixelText(true);
        this.unitSelectionBorderPaint.setTypeface(Typeface.create(Typeface.DEFAULT, Typeface.BOLD));
        gameEngine.updatePaintTextSize(this.unitSelectionBorderPaint, 18.0f);
        this.unitSelectionBorderPaint.setTextAlign(Paint.Align.LEFT);
        this.unitShieldBarPaint = new GamePaint();
        this.unitShieldBarPaint.set(this.unitHealthBarBackgroundPaint);
        this.unitShieldBarPaint.setARGB(255, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_TV_SATELLITE_SERVICE, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_TV_SATELLITE_SERVICE, 0);
        this.unitSelectionPaint = new GamePaint();
        this.unitSelectionPaint.setColor(Color.argb(100, 0, 0, 0));
        this.unitSelectionPaint.setStyle(Paint.Style.FILL_AND_STROKE);
        this.selectionBoxPaint = new GamePaint();
        this.selectionBoxPaint.setARGB(100, 30, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_TV_SATELLITE_SERVICE, 30);
        this.selectionBoxPaint.setTextAlign(Paint.Align.LEFT);
        this.selectionBoxPaint.setSubpixelText(true);
        this.selectionBoxPaint.setAntiAlias(true);
        ...
        if (this.isUILoggingEnabled) {
            this.buildingPreviewPaint.setARGB(255, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_TV_SATELLITE_SERVICE, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_TV_SATELLITE_SERVICE, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_TV_SATELLITE_SERVICE);
        } else {
            this.buildingPreviewPaint.setARGB(255, 30, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_TV_SATELLITE_SERVICE, 30);
        }
        this.buildingPreviewPaint.setTextAlign(Paint.Align.CENTER);
        this.buildingPreviewPaint.setSubpixelText(true);
        this.buildingPreviewPaint.setAntiAlias(true);
        ...
        this.rallyPointPaint.set(this.buildingPreviewPaint);
        ...
        this.selectionBoxBorderPaint.set(this.buildingPreviewPaint);
        ...
        if (this.isUILoggingEnabled) {
            this.buildingPreviewInvalidPaint.setARGB(255, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_TV_SATELLITE_SERVICE, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_TV_SATELLITE_SERVICE, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_TV_SATELLITE_SERVICE);
        } else {
            this.buildingPreviewInvalidPaint.setARGB(255, 30, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_TV_SATELLITE_SERVICE, 30);
        }
        this.buildingPreviewInvalidPaint.setTextAlign(Paint.Align.CENTER);
        this.buildingPreviewInvalidPaint.setSubpixelText(true);
        this.buildingPreviewInvalidPaint.setAntiAlias(true);
        ...
        this.unitRangePaint.setARGB(255, 30, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_TV_SATELLITE_SERVICE, 30);
        this.unitRangePaint.setTextAlign(Paint.Align.CENTER);
        this.unitRangePaint.setSubpixelText(true);
        this.unitRangePaint.setAntiAlias(true);
        ...
        this.unitTargetLinePaint.setARGB(150, 20, 20, 20);
        ...
        this.unitRangeBorderPaint.set(this.buildingPreviewInvalidPaint);
        this.unitRangeBorderPaint.setARGB(255, 128, 0, 0);
        gameEngine.updatePaintTextSize(this.unitRangeBorderPaint, 14.0f);
        this.unitRangeBorderPaint.setTextAlign(Paint.Align.CENTER);
        GamePaint.b(this.unitRangeBorderPaint);
        this.unitPathPaint = new GamePaint();
        this.unitPathPaint.set(this.unitRangeBorderPaint);
        this.unitPathPaint.setARGB(255, 220, 222, 49);
        this.unitPathBorderPaint = new GamePaint();
        this.unitPathBorderPaint.set(this.buildingPreviewInvalidPaint);
        gameEngine.updatePaintTextSize(this.unitPathBorderPaint, 12.0f);
        this.unitPathBorderPaint.setARGB(125, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_TV_DATA_SERVICE, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_TV_DATA_SERVICE, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_TV_DATA_SERVICE);
        this.unitPathBorderPaint.setTextAlign(Paint.Align.CENTER);
        GamePaint.b(this.unitPathBorderPaint);
        this.unitIconTexture = new GamePaint();
        this.unitIconTexture.setColor(-16777216);
        this.unitIconTexture.setAntiAlias(true);
        this.unitIconTexture.setSubpixelText(true);
        this.unitIconTexture.setTypeface(Typeface.create(Typeface.DEFAULT, Typeface.NORMAL));
        gameEngine.updatePaintTextSize(this.unitIconTexture, 14.0f);
        this.buildingIconTexture = new GamePaint();
        this.buildingIconTexture.set(this.unitIconTexture);
        this.buildingIconTexture.setTypeface(Typeface.create(Typeface.DEFAULT, Typeface.BOLD));
        gameEngine.updatePaintTextSize(this.buildingIconTexture, 16.0f);
        this.effectIconTexture = new GamePaint();
        this.effectIconTexture.set(this.buildingIconTexture);
        this.effectIconTexture.setColor(Color.rgb(SlickToAndroidKeycodes.AndroidCodes.KEYCODE_TV_RADIO_SERVICE, 63, 80));
        gameEngine.updatePaintTextSize(this.effectIconTexture, 16.0f);
        this.fogOfWarPaint = new GamePaint();
        this.fogOfWarPaint.setColor(-16777216);
        this.fogOfWarPaint.setTextAlign(Paint.Align.CENTER);
        this.fogOfWarPaint.setAntiAlias(true);
        this.fogOfWarPaint.setSubpixelText(true);
        this.fogOfWarPaint.setTypeface(Typeface.create(Typeface.DEFAULT, Typeface.NORMAL));
        gameEngine.updatePaintTextSize(this.fogOfWarPaint, 20.0f);
        this.minimapPaint = new GamePaint();
        this.minimapPaint.setColor(-1);
        this.minimapPaint.setAlpha(160);
        if (GameEngine.isPC()) {
            this.minimapPaint.setAlpha(140);
        }
        gameEngine.updatePaint(this.minimapPaint);
        this.minimapBorderPaint = new GamePaint();
        this.minimapBorderPaint.setColor(-16777216);
        this.minimapBorderPaint.setAlpha(210);
        gameEngine.updatePaint(this.minimapBorderPaint);
        this.minimapViewportBorderPaint = new GamePaint();
        this.minimapViewportBorderPaint.setColor(-7829368);
        this.minimapViewportBorderPaint.setAlpha(SlickToAndroidKeycodes.AndroidCodes.KEYCODE_TV_SATELLITE_SERVICE);
        this.minimapViewportBorderPaint.setStyle(Paint.Style.STROKE);
        this.minimapViewportBorderPaint.setStrokeWidth(1.0f);
        gameEngine.updatePaint(this.minimapViewportBorderPaint);
        this.minimapUnitPaint = new GamePaint();
        this.minimapUnitPaint.setColor(-16711936);
        this.minimapUnitPaint.setAlpha(80);
        this.minimapUnitPaint.setStyle(Paint.Style.FILL);
        this.minimapUnitPaint.setStrokeWidth(4.0f);
        gameEngine.updatePaint(this.minimapUnitPaint);
        this.minimapViewportPaint = new GamePaint();
        this.minimapViewportPaint.setColor(Color.argb(120, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_TV_TERRESTRIAL_ANALOG, 167, 49));
        this.minimapViewportPaint.setStyle(Paint.Style.FILL);
        this.minimapViewportPaint.setStrokeWidth(8.0f);
        gameEngine.updatePaint(this.minimapViewportPaint);
        this.unitTargetLineBorderPaint = new GamePaint();
        this.unitTargetLineBorderPaint.setSubpixelText(true);
        this.unitTargetLineBorderPaint.setAntiAlias(true);
    ...
    public void updateInput(float f) throws ConfigParseException {
        ...
        if (GameEngine.isPC() && !gameEngine.isStopped && gameEngine.activity != null && ((gameEngine.activity.isRendering() || GameEngine.isNetworkConnectedStatic2) && (!this.isMousePressed || this.interfaceRenderer.isDragging))) {
            ...
            this.interfaceRenderer.selectionRectF2.left -= (gameEngine.viewpointX - f8) * gameEngine.zoom;
            this.interfaceRenderer.selectionRectF2.top -= (gameEngine.viewpointY - f9) * gameEngine.zoom;
        }
    ...
    public void processTouchInput(float f) {
        ...
        this.bx.set((int) (gameEngine.screenWidth - gameEngine.sidebarWidth), 0, (int) gameEngine.screenWidth, (int) gameEngine.viewpointWidthRaw);
        if (!bO) {
            if (this.isUILoggingEnabled) {
                this.bA.reset();
    ...
    public void drawTeamResources(GameEngine gameEngine, PlayerTeam playerTeam, boolean isAily, boolean showDetails) {
        ...
        if (showDetails) {
            ...
            for (Resource resource : Resource.f()) {
                if (resource.a() && (resource.p || resource.j)) {
                    this.temporaryResources.c(resource);
                }
            }
            this.temporaryResources.a();
    ...
    public boolean drawInteractiveLabel(ConfirmationResult confirmationResult, boolean z) {
        ...
        if (confirmationResult == ConfirmationResult.more) {
            ...
            this.by.set(i2 + i4, i3, i2 + i4 + i, i3 + i);
            gameEngine.graphicsEngine2.a(this.bc, this.by.left, this.by.top, this.tooltipBackgroundPaint, 0.0f, f);
        } else if (confirmationResult == ConfirmationResult.yes) {
            this.by.set(i2, i3, i2 + i, i3 + i);
            gameEngine.graphicsEngine2.a(this.bb, this.by.left, this.by.top, this.tooltipBackgroundPaint, 0.0f, f);
        } else {
            int i5 = ((int) (20.0f * f)) + i;
            this.by.set(i2 + i5, i3, i2 + i5 + i, i3 + i);
            gameEngine.graphicsEngine2.a(this.ba, this.by.left, this.by.top, this.tooltipBackgroundPaint, 0.0f, f);
        }
        boolean z2 = false;
        Utility.grow(this.by, 10.0f * f);
        if (this.isSelectionBoxActive && !this.isInputDisabled && this.by.contains((int) this.selectionBoxStartX, (int) this.selectionBoxStartY)) {
            z2 = true;
        }
    ...
    public void handleTouchGestures(float f) {
        ...
        if (pointScreenToWorld != null) {
            f2 = pointScreenToWorld.x;
            f3 = pointScreenToWorld.y;
        } else {
        ...
        this.bx.set((int) (gameEngine.screenWidth - gameEngine.sidebarWidth), 0, (int) gameEngine.screenWidth, (int) gameEngine.viewpointWidthRaw);
        if (!bO && ((this.isSelectionBoxActive || this.isMousePressed) && this.bx.contains((int) this.selectionBoxStartX, (int) this.selectionBoxStartY))) {
        ...
        if (this.currentAction == null && this.isMousePressed && !this.isInputDisabled && !this.isRightMousePressed && !this.showDebugInfo) {
            this.unitHealthBarPaint.setStyle(Paint.Style.FILL);
            this.unitHealthBarPaint.setStrokeWidth(1.0f);
            if (this.uiScale > 20.0f && shouldUseCircleSelect()) {
                float fCalculateUIWidth2 = calculateUIWidth();
                this.unitHealthBarPaint.setARGB(100, 0, 255, 0);
                gameEngine.graphicsEngine2.a(this.selectionBoxStartX, this.selectionBoxStartY, fCalculateUIWidth2, this.unitHealthBarPaint);
                this.unitHealthBarPaint.setStyle(Paint.Style.STROKE);
                this.unitHealthBarPaint.setStrokeWidth(1.0f);
                this.unitHealthBarPaint.setARGB(200, 0, 255, 0);
                gameEngine.graphicsEngine2.a(this.selectionBoxStartX, this.selectionBoxStartY, fCalculateUIWidth2, this.unitHealthBarPaint);
            }
        }
    ...
    public void drawActionPreview(float f, float f2, float f3, Point point) {
        GameEngine gameEngine = GameEngine.getInstance();
        BaseUnit baseUnitF = this.interfaceRenderer.e();
        ...
        if (this.currentAction != null) {
            ...
            if (this.currentAction.e() == ActionType.targetGround) {
                drawActionTooltip(this.currentAction, false, baseUnitF, false, true);
                BaseUnit baseUnitF2 = this.interfaceRenderer.e();
    ...
    public void handleBuildingPlacement(final float float1, final float float2, final Point point) {
        ...
        final BaseUnit f = this.interfaceRenderer.e();
        boolean b = false;
        ...
        boolean b12 = false;
        if (GameEngine.isIOS() && instance.settingsEngine.mouseSupport && !instance.cameraBoundsEnabled.contains((int)this.selectionBoxMinWidth, (int)this.selectionBoxMinHeight)) {
            b12 = true;
        }
        ...
        if (this.isBuildingMode && !b12) {
            ...
            if (unitType.p()) {
                ...
                if (closestOpenPlacement != null) {
                    y.posX = (float)closestOpenPlacement.x;
                    y.posY = (float)closestOpenPlacement.y;
                }
            }
            if (!y.bI()) {
    ...
    public void issueMoveCommand(float worldX, float worldY, Point ScreenPoint) {
        ...
        if (ScreenPoint != null) {
            Point pointWorldToScreen = gameEngine.minimap.worldToScreen(ScreenPoint.x, ScreenPoint.y);
            Effect effectCreateEffect2 = gameEngine.effectManager.createEffect(pointWorldToScreen.x, pointWorldToScreen.y, 0.0f, EffectType.custom, true, EffectQuality.critical);
    ...
    public void sendMapPing(float f, float f2, PlayerTeam playerTeam, PingMapAction pingMapAction) {
        ...
        if (gameEngine.settingsEngine.showMapPingsOnMinimap) {
            ...
            Effect effectCreateEffect3 = gameEngine.effectManager.createEffect(pointWorldToScreen.x, pointWorldToScreen.y, 0.0f, EffectType.custom, true, EffectQuality.critical);
            ...
            Effect effectCreateEffect4 = gameEngine.effectManager.createEffect(pointWorldToScreen.x, pointWorldToScreen.y, 0.0f, EffectType.custom, true, EffectQuality.critical);
    ...
    public void executeUnitAction(float f, float f2, Point point, boolean z) {
        ...
        if (point != null) {
            Point pointWorldToScreen = gameEngine.minimap.worldToScreen(point.x, point.y);
            Effect effectCreateEffect2 = gameEngine.effectManager.createEffect(pointWorldToScreen.x, pointWorldToScreen.y, 0.0f, EffectType.custom, true, EffectQuality.critical);
            if (effectCreateEffect2 != null) {
                effectCreateEffect2.ar = (short) 4;
                effectCreateEffect2.ap = 9;
    ...
    public void a(String str, Rect rect, Paint paint, Paint paint2) {
        ...
        for (String str2 : Utility.splitByChar(str, '\n')) {
            ...
            gameEngine.graphicsEngine2.a(str2, rect.centerX(), rect.top + (lineHeight / 2) + (i * lineHeight), paint4);
            i++;
        }
    }
    ...
    public boolean drawActionTooltip2(final AbstractUnitAction s, final boolean boolean2, final BaseUnit am, final boolean boolean4, final boolean boolean5, final float float6, final boolean boolean7) {
        ...
        final float n2 = (float)this.bv.centerY();
        this.bv.left = (int)(n2 - a2.b.width() / 2);
        this.bv.right = (int)(n2 + a2.b.width() / 2);
        this.bv.bottom = this.bv.top + a2.b.height();
        if (boolean8) {
            final Rect bv = this.bv;
            bv.left -= (int)(n * instance.screenScale);
            final Rect bv2 = this.bv;
            bv2.right += (int)(n * instance.screenScale);
        }
        if (b8) {
            final int active = (int)(c - 7.0f * instance.screenScale - this.bv.right);
            this.bv.offset(active, 0);
        }
        this.bw.set(this.bv);
        ...
        if (am != null && b2 && active != -1) {
            ...
            bw3.bottom += (int)(55.0f * instance.screenScale);
        }
        if (this.bw.bottom > instance.viewpointWidthRaw) {
            final int n3 = (int)(instance.viewpointWidthRaw - this.bw.bottom);
            this.bv.offset(0, n3);
            this.bw.offset(0, n3);
        }
        ...
        if (unitType != null && am != null) {
            ...
            bw4.top -= (int)(40.0f * instance.screenScale);
        }
        if (b) {
        ...
        if (b9) {
            ...
            final int n5 = (int)(float7 - this.bw.bottom);
            this.bw.offset(0, n5);
            this.bv.offset(0, n5);
        }
        if (this.bw.top < 0) {
            final int n4 = 0 - this.bw.top;
            this.bw.offset(0, n4);
            this.bv.offset(0, n4);
        }
        if (this.bw.bottom > instance.viewpointWidthRaw - 20.0f) {
        ...
        if (unitType != null && am != null) {
            ...
            UnitTypeEnum.drawUnit(unitType, (float)this.bw.centerX(), this.bw.top + 22.0f * instance.screenScale, this.selectionBoxStartTime, 0.0f, am.team, float7, 100.0f * instance.screenScale, false, false, s.getQueueSize(), null);
        }
        a2.a((float)this.bv.centerY(), (float)this.bv.top);
        if (am != null && active != -1 && b2) {
            ...
            if (!b3 || active > 0) {
                ...
                if (timerValue != 0.0f) {
                    ...
                    int integer1;
                    if (timerValue > 0.0f) {
                        integer1 = Color.argb(110, 30, 240, 30);
                    }
                    else {
                        integer1 = Color.argb(110, 240, 30, 30);
                    }
                    Utility.getRandomIntInRange(integer1, this.fogOfWarPaint.getColor(), clampTo255);
                }
                float clampTo255 = this.bw.bottom - 65.0f * float7 / 2.0f + TextUtils.getCharWidth(this.fogOfWarPaint) / 2;
                if (timerValue > 0.5) {
                    ++clampTo255;
                }
                if (timerValue < -0.5) {
            ...
            int i = (int)(this.bw.bottom - 65.0f * float7);
            this.by.set(n6, i, n6 + n5, i + n5);
            Paint paint4;
            if (b12) {
            ...
            if (timerValue > 0.0f) {
                ...
                int n8;
                if (timerValue > 0.0f) {
                    n8 = Color.argb(110, 210, 210, 210);
                }
                else {
                    n8 = Color.argb(110, 210, 110, 110);
                }
            ...
            instance.graphicsEngine2.a(this.bh, (float)this.by.left, (float)this.by.top, paint4, 0.0f, float7);
            Utility.grow(this.by, this.by.width() * 0.8f);
            if (this.isSelectionBoxActive && !this.isInputDisabled && !b4 && this.by.contains((int)this.selectionBoxStartX, (int)this.selectionBoxStartY)) {
                this.isSelectionBoxActive = false;
                b10 = true;
            }
            n6 = (int)(this.bw.centerX() - n5 - 60.0f * float7);
            i = (int)(this.bw.bottom - 65.0f * float7);
            this.by.set(n6, i, n6 + n5, i + n5);
            Paint paint5;
            if (b13) {
            ...
            instance.graphicsEngine2.a(this.bi, (float)this.by.left, (float)this.by.top, paint5, 0.0f, float7);
            Utility.grow(this.by, this.by.width() * 0.8f);
            if (this.isSelectionBoxActive && !this.isInputDisabled && this.by.contains((int)this.selectionBoxStartX, (int)this.selectionBoxStartY)) {
                this.isSelectionBoxActive = false;
                b11 = true;
            ...
            if (!b10 && !b11 && this.isSelectionBoxActive && !this.isInputDisabled && !this.bw.contains((int)this.selectionBoxStartX, (int)this.selectionBoxStartY)) {
                return true;
            }
        }
        return !b2 && GameEngine.isAndroid() && this.isSelectionBoxActive && !this.isInputDisabled && !this.bw.contains((int)this.selectionBoxStartX, (int)this.selectionBoxStartY);
    }

    public void a(Rect rect, Paint paint, Paint paint2) {
        GameEngine gameEngine = GameEngine.getInstance();
        if (bO) {
            gameEngine.graphicsEngine2.a(this.bl, rect, paint2, rect.left, rect.top, 0, 0);
            if (paint != null) {
    ...
    public void a(int i, int i2, int i3, int i4, String str, int i5, Paint paint, boolean z, UIStyle uIStyle, UIState uIState) {
        ...
        if (uIStyle == null) {
            int iA = Color.argb(255, 0, 0, 0);
            if (bO) {
                iA = Color.argb(100, 0, 0, 0);
            }
            a(this.bx, iA, false);
        }
    ...
    public void a(int i, int i2, int i3, int i4, String str, int i5, Paint paint) {
        ...
        if (GameEngine.isAndroidVersionStatic2) {
            ...
            gameEngine.graphicsEngine2.a(str, this.bx.centerX(), this.bx.centerY() - ((paint.ascent() + paint.descent()) / 2.0f), paint);
        }
    }
    ...
    public void a(Rect rect) {
        if (rect.contains((int) this.selectionBoxMinWidth, (int) this.selectionBoxMinHeight)) {
    ...
    public void a(float f, float f2, float f3, float f4) {
        this.debugTextRect.set((int) f, (int) f2, (int) (f + f3), (int) (f2 + f4));
    ...
    public boolean a(int i, int i2, int i3, int i4, IconGroup iconGroup, boolean z) {
        a(i, i2, i3, i4);
        this.bx.set(i, i2, i + i3, i2 + i4);
        if (((z && this.isMousePressed) || this.isSelectionBoxActive) && this.bx.contains((int) this.selectionBoxStartX, (int) this.selectionBoxStartY)) {
            return true;
        }
        return false;
    }
    ...
    public boolean a(int i, int i2, int i3, int i4, IconGroup iconGroup) {
        this.bx.set(i, i2, i + i3, i2 + i4);
        GameEngine gameEngine = GameEngine.getInstance();
        if (GameEngine.isIOS() && gameEngine.settingsEngine.mouseSupport && this.bx.contains((int) gameEngine.getTouchX(), (int) gameEngine.getTouchY())) {
            return true;
        }
        return false;
    }
    ...
    public boolean b(int i, int i2, int i3, int i4, IconGroup iconGroup) {
        this.bx.set(i, i2, i + i3, i2 + i4);
        if (this.isRightClickDrag && this.bx.contains((int) this.selectionBoxStartX, (int) this.selectionBoxStartY)) {
            return true;
        }
        return false;
    }
