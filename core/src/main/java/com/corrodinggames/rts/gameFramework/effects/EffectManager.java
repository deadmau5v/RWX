...
public final class EffectManager {
    ...
    public Effect createEffectInternal(float f, float f2, float f3, EffectType effectType, boolean z, EffectQuality effectQuality) {
        ...
        if (this.onlyOnScreen) {
            ...
            if (!gameEngine.cameraFollowZoom.contains(f, f2)) {
                return null;
            }
        }
        ...
        if (gameEngine.cameraFollowSpeed.contains(f, f2)) {
        ...
        } else if (z2 || gameEngine.cameraFollowZoom.contains(f, f2)) {
        }
    ...
    public void loadContent(Context context) {
        int i;
        GameEngine gameEngine = GameEngine.getInstance();
        this.linePaint.setARGB(130, 200, 0, 0);
