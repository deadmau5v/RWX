...
public class Leaderboard {
    ...
    public int draw(float f, int i) {
        ...
        this.backgroundRect.left = i5 - 6;
        this.backgroundRect.right = i5 + 6 + fCeil;
        this.backgroundRect.top = (i2 - 6) - i4;
        this.backgroundRect.bottom = i2 + 6 + ((arrayList.size() - 1) * i4);
        GamePaint gamePaint = new GamePaint();
        gamePaint.setColor(Color.a(100, 0, 0, 0));
        ...
        for (int i6 = 0; i6 < arrayList.size(); i6++) {
            ...
            leaderboardRow4.labelPaint.setColor(leaderboardRow4.teamId);
            gameEngine.graphicsEngine2.a(leaderboardRow4.label, i5, i2, leaderboardRow4.labelPaint);
            leaderboardRow4.valuePaint.setColor(leaderboardRow4.color);
