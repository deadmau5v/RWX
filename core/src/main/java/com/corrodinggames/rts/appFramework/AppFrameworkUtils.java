...
public class AppFrameworkUtils {
        ...
        DialogInterface.OnClickListener onClickListener2 = new DialogInterface.OnClickListener() { // from class: com.corrodinggames.rts.appFramework.c.2
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                if (activity instanceof TaskQueueActivity) {
                    if (runnable != null) {
                        ((TaskQueueActivity) activity).runOrQueue(new Runnable() { // from class: com.corrodinggames.rts.appFramework.c.2.1
    ...
    public static boolean hasStoragePermission(Context context) {
        if (GameEngine.isPausedStatic2 || !FileHelper.isZip() || Build.VERSION.SDK_INT < 23 || ContextCompat.checkSelfPermission(context, "android.permission.WRITE_EXTERNAL_STORAGE") == 0) {
            return true;
        }
        return false;
    }
