...
// java.lang.Runnable
            instance.uiHandler.post(() -> instance.refreshChatLogInternal());
        }
    }
    ...
    public static void addMessageToChatLog(String str) {
        ...
        Message messageA = multiplayerBattleroomActivity.chatLogUpdateHandler.obtainMessage();
        messageA.getData().putString("text", str);
        multiplayerBattleroomActivity.chatLogUpdateHandler.sendMessage(messageA);
    }
    ...
    public static void finishActivity(String str, final String str2) {
        if (instance != null) {
            instance.uiHandler.post(new Runnable() { // from class: com.corrodinggames.rts.appFramework.n.2
    ...
    public static void updateUI() {
        ...
        if (instance != null) {
            instance.uiHandler.post(instance.updateUIRunnable);
        } else {
    ...
    public static void startGame() {
        if (instance != null) {
            instance.uiHandler.post(instance.startGameRunnable);
